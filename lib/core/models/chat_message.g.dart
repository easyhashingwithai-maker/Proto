...
int _chatMessageEstimateSize(
  ...
  {
    final value = object.codeSnippet;
    if (value != null) {
...
void _chatMessageSerialize(
  ...
  writer.writeString(offsets[0], object.codeSnippet);
...
ChatMessage _chatMessageDeserialize(
  ...
  object.codeSnippet = reader.readStringOrNull(offsets[0]);
  object.id = id;
...
extension ChatMessageQueryFilter
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'codeSnippet',
      ));
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      codeSnippetIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      codeSnippetContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      codeSnippetMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition> languageEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition> languageBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition> languageMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension ChatMessageQuerySortBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByCodeSnippet() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'codeSnippet', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByCodeSnippetDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'codeSnippet', Sort.desc);
    });
  }
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByLanguage() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'language', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByLanguageDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ChatMessageQuerySortThenBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByCodeSnippet() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'codeSnippet', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByCodeSnippetDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'codeSnippet', Sort.desc);
    });
  }
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByLanguage() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'language', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByLanguageDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'language', Sort.desc);
    });
  }
...
extension ChatMessageQueryWhereDistinct
  ...
  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctByCodeSnippet(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'codeSnippet', caseSensitive: caseSensitive);
    });
  }
  ...
  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctByLanguage(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ChatMessageQueryProperty
  ...
  QueryBuilder<ChatMessage, String?, QQueryOperations> codeSnippetProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'codeSnippet');
    });
  }
  ...
  QueryBuilder<ChatMessage, String?, QQueryOperations> languageProperty() {
    return QueryBuilder.apply(this, (query) {
